import { Component, Suspense, createContext, forwardRef, useContext, useEffect, useMemo, useRef, useState } from "react";
...
var Button = forwardRef(({ className, variant, size, type = "button", ...props }, ref) => {
...
//#endregion
//#region src/components/game/Overlay.tsx
...
function Overlay() {
	...
	return /* @__PURE__ */ jsxs("div", {
		...
		children: [
					...
					children: [
						...
						/* @__PURE__ */ jsxs("ul", {
							...
							children: [
								...
								/* @__PURE__ */ jsxs("li", {
									className: "flex items-center gap-2",
									children: [/* @__PURE__ */ jsx(DoorOpen, {
										className: "size-4",
										strokeWidth: 1.75
									}), "E interact"]
								}),
								/* @__PURE__ */ jsxs("li", {
									className: "flex items-center gap-2",
									children: [/* @__PURE__ */ jsx(Armchair, {
										className: "size-4",
										strokeWidth: 1.75
									}), "Sit / stand"]
								}),
			...
			phase === "playing" && /* @__PURE__ */ jsxs(Fragment, { children: [
				pose === "stand" && !coarse && /* @__PURE__ */ jsx("div", {
				...
				/* @__PURE__ */ jsxs("div", {
					...
					}), /* @__PURE__ */ jsx("div", { children: pose === "desk" ? "Working" : pose === "bed" ? "Resting" : pose === "balconyChair" ? "Looking out" : "On foot" })]
				}),
				prompt && /* @__PURE__ */ jsx("div", {
...
//#endregion
//#region src/components/game/TouchControls.tsx
...
//#endregion
//#region src/game/MatsContext.tsx
var MatsContext = createContext(null);
...
function Doors() {
	...
	return /* @__PURE__ */ jsxs("group", { children: [
		...
		/* @__PURE__ */ jsx("group", {
			...
			children: /* @__PURE__ */ jsx(DoorPanel, {
				width: ROOM.doorW - .04,
				height: h,
				clothes: true
			})
...
function Building({ position, size }) {
	return /* @__PURE__ */ jsxs("group", {
		...
		}), [-.35, .35].map((ox) => [.3, -.35].map((oy) => /* @__PURE__ */ jsxs("mesh", {
			position: [
				ox,
				oy,
				size[2] / 2 + .01
			],
			children: [/* @__PURE__ */ jsx("planeGeometry", { args: [.28, .38] }), /* @__PURE__ */ jsx("meshStandardMaterial", {
				color: "#c5d0d8",
				roughness: .3
			})]
		}, `${ox}${oy}`)))]
...
function Exterior() {
	...
	return /* @__PURE__ */ jsxs("group", { children: [
		...
		/* @__PURE__ */ jsx("mesh", {
			...
			material: m.city,
			children: /* @__PURE__ */ jsx("planeGeometry", { args: [42, 16] })
		}),
		/* @__PURE__ */ jsxs("mesh", {
			rotation: [
				-Math.PI / 2,
			...
			receiveShadow: true,
			children: [/* @__PURE__ */ jsx("planeGeometry", { args: [40, 28] }), /* @__PURE__ */ jsx("meshStandardMaterial", {
				color: "#7a9a4a",
				roughness: .95
			})]
		}),
		/* @__PURE__ */ jsxs("mesh", {
			...
			children: [/* @__PURE__ */ jsx("planeGeometry", { args: [12, 8] }), /* @__PURE__ */ jsx("meshStandardMaterial", {
				color: "#c4b07a",
				roughness: .9
			})]
		}),
		...
		/* @__PURE__ */ jsxs("mesh", {
			...
			children: [/* @__PURE__ */ jsx("boxGeometry", { args: [
				...
				.12,
				.4
			] }), /* @__PURE__ */ jsx("meshStandardMaterial", { color: "#6a6a68" })]
		}),
		[
			-2.2,
			-.7,
...
function createMaterials() {
	...
	const wallHall = new THREE.MeshStandardMaterial({
		map: hallPlaster,
		roughness: .9,
		color: "#f3eee6"
	});
	...
	const floorHall = new THREE.MeshStandardMaterial({
		map: tileMap,
		roughness: .3
	});
...
function Ivy({ origin }) {
	...
	return /* @__PURE__ */ jsx("group", {
		...
		children: pts.map((p, i) => /* @__PURE__ */ jsxs("mesh", {
			position: p,
			rotation: [
				.4,
				i * .3,
...
function Laptop() {
	...
	return /* @__PURE__ */ jsxs("group", { children: [
		...
		/* @__PURE__ */ jsx("mesh", {
			...
			material: m.screen,
			children: /* @__PURE__ */ jsx("planeGeometry", { args: [.28, .16] })
		})
	] });
}
...
function Furniture() {
	...
	return /* @__PURE__ */ jsxs("group", { children: [
		...
		atDesk && /* @__PURE__ */ jsx("pointLight", {
			position: [
				-.95,
				1.05,
				-2.45
		...
		/* @__PURE__ */ jsx(OfficeChair, { position: [
			-1,
			0,
			-1
		] }),
		/* @__PURE__ */ jsx("mesh", {
			...
			material: m.felt,
			children: /* @__PURE__ */ jsx("planeGeometry", { args: [1.45, 1.35] })
		}),
		/* @__PURE__ */ jsx("mesh", {
			position: [
				-2.2,
		...
		lampOn && /* @__PURE__ */ jsx("pointLight", {
			position: [
				-2,
				1.5,
				-1
		...
		/* @__PURE__ */ jsxs("mesh", {
			...
			children: [/* @__PURE__ */ jsx("boxGeometry", { args: [
				...
				.08,
				.02
			] }), /* @__PURE__ */ jsx("meshStandardMaterial", { color: "#f4f1ea" })]
		}),
		/* @__PURE__ */ jsxs("mesh", {
			position: [
				-2,
		...
		/* @__PURE__ */ jsxs("mesh", {
			...
			receiveShadow: true,
			children: [/* @__PURE__ */ jsx("circleGeometry", { args: [.32, 16] }), /* @__PURE__ */ jsx("meshStandardMaterial", {
				color: "#c4b08a",
				roughness: .95
			})]
		}),
		...
		/* @__PURE__ */ jsx("mesh", {
			...
			receiveShadow: true,
			material: m.rug,
			children: /* @__PURE__ */ jsx("planeGeometry", { args: [.78, 1.55] })
		}),
		/* @__PURE__ */ jsxs("group", {
			position: [
				2.22,
		...
		/* @__PURE__ */ jsxs("mesh", {
			...
			children: [/* @__PURE__ */ jsx("planeGeometry", { args: [.55, 1.15] }), /* @__PURE__ */ jsx("meshStandardMaterial", {
				color: "#b8c8d4",
				metalness: .6,
				roughness: .15
			})]
		...
		/* @__PURE__ */ jsx("mesh", {
			...
			material: m.art,
			children: /* @__PURE__ */ jsx("planeGeometry", { args: [.7, .95] })
		}),
		/* @__PURE__ */ jsxs("mesh", {
			position: [
				1.55,
			...
			children: [/* @__PURE__ */ jsx("circleGeometry", { args: [.08, 10] }), /* @__PURE__ */ jsx("meshStandardMaterial", {
				color: "#3a3a38",
				roughness: .6
			})]
		}),
...
function Player() {
	...
	const x = useRef(SPAWN.x);
	const y = useRef(SPAWN.y);
	const z = useRef(SPAWN.z);
	const vy = useRef(0);
...
function Wall({ position, size }) {
	...
	return /* @__PURE__ */ jsx("mesh", {
		...
		receiveShadow: true,
		material: m.wall,
		children: /* @__PURE__ */ jsx("boxGeometry", { args: size })
	});
}
function CeilingFan() {
	const m = useMats();
...
function Room() {
	...
	return /* @__PURE__ */ jsxs("group", { children: [
		/* @__PURE__ */ jsx("mesh", {
			...
			receiveShadow: true,
			material: m.floor,
			children: /* @__PURE__ */ jsx("planeGeometry", { args: [roomWidth + .3, roomDepth + .3] })
		}),
		/* @__PURE__ */ jsx("mesh", {
			rotation: [
				-Math.PI / 2,
			...
			children: /* @__PURE__ */ jsx("planeGeometry", { args: [hallWidth + .15, hallDepth + .15] })
		}),
		/* @__PURE__ */ jsx("mesh", {
			rotation: [
				-Math.PI / 2,
			...
			receiveShadow: true,
			material: m.concrete,
			children: /* @__PURE__ */ jsx("planeGeometry", { args: [BALCONY.maxX - BALCONY.minX + .3, BALCONY.maxZ - BALCONY.minZ + .2] })
		}),
		/* @__PURE__ */ jsx("mesh", {
			position: [
				0,
		...
		/* @__PURE__ */ jsx("mesh", {
			...
			material: m.glass,
			children: /* @__PURE__ */ jsx("planeGeometry", { args: [ww - .08, 1.85] })
		}),
		[
			-.45,
			0,
			.45
		].map((ox) => /* @__PURE__ */ jsx("mesh", {
			position: [
				wx + ox,
				1.35,
				ROOM.minZ + .01
		...
		/* @__PURE__ */ jsx("mesh", {
			...
			material: m.curtain,
			children: /* @__PURE__ */ jsx("planeGeometry", { args: [.62, 2.05] })
		}),
		/* @__PURE__ */ jsx("mesh", {
			position: [
				wx + .34,
		...
		/* @__PURE__ */ jsx(CeilingFan, {})
	] });
}
//#endregion
//#region src/game/World.tsx
function Dust() {
	...
	return /* @__PURE__ */ jsxs("points", { children: [/* @__PURE__ */ jsx("bufferGeometry", { children: /* @__PURE__ */ jsx("bufferAttribute", {
...
function World() {
	...
	return /* @__PURE__ */ jsxs(MatsProvider, {
		value: mats,
		children: [
			/* @__PURE__ */ jsx(SceneFog, {}),
...
//#endregion
//#region src/game/HavenGame.tsx
var GLBoundary = class extends Component {
	state = { err: false };
	static getDerivedStateFromError() {
		return { err: true };
	}
	render() {
		if (this.state.err) return /* @__PURE__ */ jsx(WebGLError, {});
...
function HavenGame() {
	...
	return /* @__PURE__ */ jsx(GLBoundary, { children: /* @__PURE__ */ jsxs("div", {
		className: "relative h-dvh w-full overflow-hidden bg-bg touch-none",
		children: [
			client ? /* @__PURE__ */ jsx(Scene, {}) : /* @__PURE__ */ jsx("div", { className: "absolute inset-0 bg-bg" }),
			/* @__PURE__ */ jsx(Overlay, {}),
			client ? /* @__PURE__ */ jsx(TouchControls, {}) : null
		]
	}) });
}
//#endregion
